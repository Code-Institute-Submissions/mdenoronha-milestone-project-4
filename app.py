...
def register():
    ...
    # ADD SOME MORE HERE
    user55 = User(first_name='testing-account-not-viewed-recipe',last_name = 'testing-account-not-viewed-recipe',username='testing-account-not-viewed-recipe',password='testing-account-not-viewed-recipe')
    user56 = User(first_name='testing-account-viewed-recipe',last_name = 'testing-account-viewed-recipe',username='testing-account-viewed-recipe',password='testing-account-viewed-recipe')
    ...
    # ADD SOME MORE HERE
    db.session.add(user55)
    db.session.add(user56)
    ...
    Ingredients1 = Ingredients(amount=u'400g',name = u'pumpkin',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients1 = Ingredients(amount=u'120g',name = u'ricotta',is_vegetarian=1,is_vegan=0,is_gluten_free=0)
    Ingredients1 = Ingredients(amount=u'50g',name = u'grated parmesan',is_vegetarian=1,is_vegan=0,is_gluten_free=0)
    Ingredients1 = Ingredients(amount=u'1',name = u'egg',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients1 = Ingredients(amount=u'200g',name = u'plain flour',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients1 = Ingredients(amount=u'60g',name = u'salted butter',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients1 = Ingredients(amount=u'1tsp',name = u'oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients1 = Ingredients(amount=u'20',name = u'sage leaves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe2= Recipe(name=u'crispy chicken with creamy mushrooms and braised leeks',serves= 1,difficulty=u'easy',time=10,views=62,method=u"Preheat the oven to gas 6, 200°C, fan 180°C. Heat 1 tbsp oil in a large frying pan over a medium heat and add the onions. Cook for 15-20 mins until softened and lightly golden. Transfer to a roasting tin and set aside.Add the mushrooms to the pan and turn the heat up to high. Cook for 8-10 mins until soft, then add to the roasting tin.Season the chicken thighs, add to the pan and reduce the heat to medium-high. Cook skin side down for 10 mins or until the skin is golden and crisp. Turn and cook for a further 5 mins. Transfer to the roasting tin and wipe the pan clean with kitchen paper.Pour the chicken stock into the roasting tin and roast for 25 mins or until the chicken is cooked through.Meanwhile, heat the remaining oil in the frying pan over a medium-high heat. Add the leeks, cut side down, and cook for 4 mins or until lightly golden. Using tongs, turn the leeks so the cut sides face up, then pour in 150ml hot water. Cover and simmer for 15-20 mins until tender.Transfer the chicken to a plate and cover with foil to keep warm. Put the mushrooms, onions and cooking juices in a saucepan, then stir in the crème fraîche, mustard and cornflour. Season to taste. Simmer for 2-3 mins until thickened.Divide the chicken and sauce between plates and serve the leeks alongside. Garnish with the parsley and a twist of black pepper.",user_id=6,image_file=u'temp2.jpg')
    Ingredients3 = Ingredients(amount=u'2tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients4 = Ingredients(amount=u'2',name = u'onions',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients5 = Ingredients(amount=u'250g',name = u'closed cup mushrooms',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients6 = Ingredients(amount=u'8',name = u'chicken thighs',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients7 = Ingredients(amount=u'400ml',name = u'chicken stock',is_vegetarian=0,is_vegan=0,is_gluten_free=0)
    Ingredients8 = Ingredients(amount=u'100ml',name = u'half-fat crème fraîche',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients9 = Ingredients(amount=u'2 heaped tsp',name = u'Dijon mustard',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients10 = Ingredients(amount=u'1 1/2tsp',name = u'cornflour',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients11 = Ingredients(amount=u'1tbsp',name = u'chopped parsley',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients12 = Ingredients(amount=u'2',name = u'leeks',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe3= Recipe(name=u'one-pot linguine with olives, capers and sundried tomatoes recipe',serves= 4,difficulty=u'medium',time=20,views=15,method=u"Pour the passata into a large saucepan and stir in the olives, capers, sundried tomatoes, 1 tsp salt and 500ml water. Bring to a simmer.Add the pasta, and use tongs to stir the pasta into the sauce as it softens. Continue to cook, uncovered, for 11-12 mins, until the pasta is cooked but still al dente and the sauce is reduced and coats the pasta.",user_id=8,image_file=u'temp3.jpg')
    Ingredients13 = Ingredients(amount=u'500g',name = u'carton passata with basil',is_vegetarian=1,is_vegan=0,is_gluten_free=0)
    Ingredients14 = Ingredients(amount=u'75g',name = u'pitted black olives',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients15 = Ingredients(amount=u'30g',name = u'capucine capers',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients16 = Ingredients(amount=u'75g',name = u'sundried tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients17 = Ingredients(amount=u'350g',name = u'linguine',is_vegetarian=1,is_vegan=0,is_gluten_free=0)
    Recipe4= Recipe(name=u'barbecue sausage and mixed bean bake recipe',serves= 2,difficulty=u'hard',time=100,views=65,method=u"Preheat the oven to gas 6, 200°C, fan 180°C. Put the oil in a roasting tin and heat in the oven for 10 mins. Add the sausages and sliced onion, toss to coat in the hot oil and roast for 10 mins.Meanwhile, preheat a griddle pan or heavy frying pan. Griddle the corn for 15 mins, turning occasionally, until charred and tender. Remove the kernels carefully by standing the cob firmly on a chopping board and slicing with a sharp knife.Remove the sausages from the oven and stir in the beans, tomatoes and barbecue sauce; season. Bake for 15 mins until the sauce is bubbling and the sausages are cooked through.Meanwhile, make the salsa. In a small bowl, mix the corn, diced red onion and parsley. Serve scattered over the sausages and beans.",user_id=29,image_file=u'temp4.jpg')
    Ingredients18 = Ingredients(amount=u'2tsp',name = u'vegetable oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients19 = Ingredients(amount=u'8',name = u'pork sausages',is_vegetarian=0,is_vegan=0,is_gluten_free=0)
    Ingredients20 = Ingredients(amount=u'1',name = u'red onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients21 = Ingredients(amount=u'2',name = u'corn on the cob',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients22 = Ingredients(amount=u'800g',name = u'mixed bean salad',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients23 = Ingredients(amount=u'400g',name = u'tin Italian chopped tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients24 = Ingredients(amount=u'3tbsp',name = u'barbecue sauce',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients25 = Ingredients(amount=u'10g',name = u'fresh flat-leaf parsley',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe5= Recipe(name=u'banana and blackberry smoothie bowls with figs recipe',serves= 2,difficulty=u'hard',time=10,views=36,method=u"Toast the seeds in a small frying pan over a medium heat for 1-2 mins until just golden. Set aside.Put the bananas, 125g blackberries and 60g yogurt in a blender with the apple juice and oats; blitz to a thick smoothie-like consistency, scraping down the sides with a spatula if necessary. Add lemon juice to taste, if you like. Divide between 2 bowls and spoon through the remaining yogurt to create a swirl effect.Arrange the sliced figs and the remaining blackberries on top, then scatter over the toasted seeds to serve",user_id=3,image_file=u'temp5.jpg')
    Ingredients26 = Ingredients(amount=u'2tsp',name = u'pumpkin seeds',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients27 = Ingredients(amount=u'2tsp',name = u'sunflower seeds',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients28 = Ingredients(amount=u'',name = u'small bananas',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients29 = Ingredients(amount=u'150g',name = u'blackberries',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients30 = Ingredients(amount=u'75g',name = u'greek-style yogurt',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients31 = Ingredients(amount=u'50ml',name = u'apple juice',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients32 = Ingredients(amount=u'1tsp',name = u'porridge oats',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients33 = Ingredients(amount=u'20ml',name = u'lemon juice',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients34 = Ingredients(amount=u'2',name = u'small ripe figs',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe6= Recipe(name=u'kale, poached egg and smoked salmon toast topper recipe',serves= 1,difficulty=u'hard',time=10,views=147,method=u"Poach the egg for 3 mins for a runny yolk or 4 mins for a set yolk. Remove and drain on kitchen paper.Meanwhile, toast the bread. Put the kale in a colander and pour over boiling water to wilt.Drizzle the toast with oil, then top with the kale, smoked salmon, the egg and chilli.",user_id=43,image_file=u'temp6.jpg')
    Ingredients35 = Ingredients(amount=u'1',name = u'egg',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients36 = Ingredients(amount=u'1 slice',name = u'rye and sunflower bread',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients37 = Ingredients(amount=u'25g',name = u'curly kale',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients38 = Ingredients(amount=u'1tsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients39 = Ingredients(amount=u'30g',name = u'smoked salmon',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients40 = Ingredients(amount=u'1',name = u'red chilli',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe7= Recipe(name=u'kale and cauliflower cheese recipe',serves= 1,difficulty=u'medium',time=50,views=55,method=u"Bring a pan of lightly salted water to the boil and cook the cauliflower for 10 minutes. Add the kale to the top of the pan and cook for a further 2 minutes, then drain well and set aside.Preheat the oven to gas 7, 220ºC, fan 200ºC. Meanwhile, melt the butter in a pan, then add the flour and cook over a low heat for 1 minute, stirring continually. Add the mustard powder, stir and remove from the heat. Gradually add the milk a little at a time, stirring well to beat out any lumps.Return to the heat and bring to a simmer, stirring all the time. Once bubbling, cook for 2-3 minutes until thickened.Stir in ⅔ of the Cheddar, half of the Manchego and half of the vegetarian hard cheese and beat well. Add the mustard and pepper and beat again. Add the drained cauliflower and kale to the sauce and toss well to coat. Transfer to a 2 pint gratin dish.Mix the remaining cheeses together and scatter over the top. Bake for 20 minutes until golden and cooked through. Serve with roast chicken or gammon as a delicious side dish.",user_id=50,image_file=u'temp7.jpg')
    Ingredients41 = Ingredients(amount=u'1',name = u'cauliflower',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients42 = Ingredients(amount=u'150g',name = u'kale',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients43 = Ingredients(amount=u'50g',name = u'butter',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients44 = Ingredients(amount=u'50g',name = u'plain flour',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients45 = Ingredients(amount=u'2tsp',name = u'mustard powder',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients46 = Ingredients(amount=u'500ml',name = u'milk',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients47 = Ingredients(amount=u'100g',name = u'mature cheddar cheese',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients48 = Ingredients(amount=u'75g',name = u'manchego cheese',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients49 = Ingredients(amount=u'50g',name = u'italian-style hard cheese',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients50 = Ingredients(amount=u'1tsp',name = u'wholegrain mustard',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients51 = Ingredients(amount=u'4tsp',name = u'ground black pepper',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe8= Recipe(name=u'celeriac, kale and potato gratin recipe',serves= 2,difficulty=u'medium',time=180,views=45,method=u"Preheat the oven to gas 2, 150°C, fan 130°C. Combine the cream, milk, garlic, sage and mustard in a pan. Heat until just coming to the boil, then remove and season with a little freshly grated nutmeg. Discard the sage.Meanwhile, blanch the kale for 1 minute in a pan of gently simmering water, then drain and refresh in cold water. Drain again, then dry with kitchen paper.Grease a baking dish with butter. Pour in a little of the cream mixture. Top with a layer of celeriac and potato, season, then top with a little kale. Repeat until all the ingredients are used up, finishing with a layer of the cream mixture. Cover with foil and bake for 1 hour 40 minutes.Heat the grill to medium. Remove the foil and finish off under the grill, until golden.",user_id=46,image_file=u'temp8.jpg')
    Ingredients52 = Ingredients(amount=u'100ml',name = u'double cream',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients53 = Ingredients(amount=u'75ml',name = u'semi-skimmed milk',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients54 = Ingredients(amount=u'1',name = u'garlic clove',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients55 = Ingredients(amount=u'3',name = u'sage leaves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients56 = Ingredients(amount=u'1tsp',name = u'dijon mustard',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients57 = Ingredients(amount=u'',name = u'nutmeg',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients58 = Ingredients(amount=u'25g',name = u'kale',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients59 = Ingredients(amount=u'',name = u'butter',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients60 = Ingredients(amount=u'100g',name = u'celeriac',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients61 = Ingredients(amount=u'150g',name = u'potatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Recipe9= Recipe(name=u'pear and broccoli soup recipe',serves= 4,difficulty=u'easy',time=30,views=64,method=u"Heat the oil in a large saucepan over a medium heat. Add the onion and cook, stirring occasionally, for 6-8 mins until soft. Add the broccoli, pears and vegetable stock. Season, then bring to the boil. Cover, reduce the heat to low and cook for 10-12 mins or until the broccoli is soft.Using a hand blender, blitz the soup until smooth. Divide between 4 bowls and top each with the blue cheese, cranberries, walnuts and a drizzle of oil to serve.",user_id=49,image_file=u'temp9.jpg')
    Ingredients62 = Ingredients(amount=u'2tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients63 = Ingredients(amount=u'1',name = u'onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients64 = Ingredients(amount=u'2',name = u'broccoli',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients65 = Ingredients(amount=u'2',name = u'conference pears',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients66 = Ingredients(amount=u'850ml',name = u'hot vegetable stock',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients67 = Ingredients(amount=u'60g',name = u'vegetarian blue cheese',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients68 = Ingredients(amount=u'20g',name = u'dried cranberries',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients69 = Ingredients(amount=u'20g',name = u'walnuts',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    ...
    Ingredients70 = Ingredients(amount=u'1tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients71 = Ingredients(amount=u'4',name = u'onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients72 = Ingredients(amount=u'1',name = u'garlic clove',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients73 = Ingredients(amount=u'6',name = u'eggs',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients74 = Ingredients(amount=u'150g',name = u'peas',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients75 = Ingredients(amount=u'125g',name = u'cherry tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients76 = Ingredients(amount=u'2',name = u'tortilla wraps',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients77 = Ingredients(amount=u'2tbsp',name = u'cream',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients78 = Ingredients(amount=u'1',name = u'red chilli',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients79 = Ingredients(amount=u'2 handfuls',name = u'salad leaves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    ...
    Ingredients80 = Ingredients(amount=u'650g',name = u'chicken breast',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients81 = Ingredients(amount=u'3 1/2tbsp',name = u'teriyaki sauce',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients82 = Ingredients(amount=u'250g',name = u'dreid medium egg noodles',is_vegetarian=0,is_vegan=0,is_gluten_free=0)
    Ingredients83 = Ingredients(amount=u'1tsp',name = u'sesame oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients84 = Ingredients(amount=u'1tbsp',name = u'soy sauce',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients85 = Ingredients(amount=u'1',name = u'broccoli',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients86 = Ingredients(amount=u'85g',name = u'mangetout',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients87 = Ingredients(amount=u'1',name = u'red chilli',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients88 = Ingredients(amount=u'3',name = u'spring onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients89 = Ingredients(amount=u'1tsp',name = u'sesame seeds',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe12= Recipe(name=u'chicken and tomato spiced curry recipe',serves= 4,difficulty=u'hard',time=30,views=164,method=u"Heat 1 tbsp of the oil in a large flameproof casserole dish set over a high heat. Working in batches if necessary, cook the chicken for 5-7 mins until golden and just cooked through, then remove and set aside.Put the remaining oil in the dish. Add the onion, cook for 3 mins until soft, then add the red pepper and cook for 2 mins. Stir in the garlic and ginger and cook for 30 secs. Stir in the curry paste until everything is well coated.Pour in the tomatoes along with 200ml water. Bring to the boil, then reduce the heat, cover the dish and leave to simmer for 10 mins until the sauce has thickened a little. Return the chicken to the dish and cook for 5 mins, uncovered, until piping hot and cooked through.Meanwhile, cook the basmati rice following pack instructions. Serve with the curry and sprinkle over the coriander to finish.",user_id=5,image_file=u'temp12.jpg')
    Ingredients90 = Ingredients(amount=u'2tbsp',name = u'vegetable oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients91 = Ingredients(amount=u'450g',name = u'chicken breast',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients92 = Ingredients(amount=u'1',name = u'onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients93 = Ingredients(amount=u'1',name = u'red pepper',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients94 = Ingredients(amount=u'2',name = u'garlic cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients95 = Ingredients(amount=u'1cm',name = u'piece ginger',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients96 = Ingredients(amount=u'2tbsp',name = u'madras curry paste',is_vegetarian=1,is_vegan=0,is_gluten_free=0)
    Ingredients97 = Ingredients(amount=u'400g',name = u'chopped tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients98 = Ingredients(amount=u'300g',name = u'basmati rice',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients99 = Ingredients(amount=u'1 handful',name = u'coriander',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe13= Recipe(name=u'gluten-free spaghetti bolognese recipe',serves= 4,difficulty=u'medium',time=180,views=13,method=u"Heat the oil in a large and sauté the onions and garlic, frying until softened. Increase the heat and add the minced beef.Fry it until it has browned, breaking down any chunks of meat with a wooden spoon. Pour in the wine and boil until it has reduced a little. Reduce the temperature and stir in the mushrooms, tomatoes and sundried tomatoes. Bring to the boil, cover and simmer for 1 hour stirring from time to time.At the end of cooking add the basil and parsley. Cook the gluten free pasta according to the packet instructions. Drain and divide between 4 warmed bowls. Ladle over the cooked bolognese sauce and finish with a sprinkling of Parmesan cheese.",user_id=1,image_file=u'temp13.jpg')
    Ingredients100 = Ingredients(amount=u'2tbsp',name = u'rapeseed oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients101 = Ingredients(amount=u'2',name = u'onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients102 = Ingredients(amount=u'4',name = u'garlic cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients103 = Ingredients(amount=u'500g',name = u'lean beef mince',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients104 = Ingredients(amount=u'100ml',name = u'red wine',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients105 = Ingredients(amount=u'150g',name = u'button mushrooms',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients106 = Ingredients(amount=u'780g',name = u'chopped tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients107 = Ingredients(amount=u'6',name = u'sun dried tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients108 = Ingredients(amount=u'2tbsp',name = u'fresh basil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients109 = Ingredients(amount=u'2tbsp',name = u'fresh parsley',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients110 = Ingredients(amount=u'',name = u'salt',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients111 = Ingredients(amount=u'',name = u'ground black pepper',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients112 = Ingredients(amount=u'400g',name = u'gluten-free spaghetti',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients113 = Ingredients(amount=u'',name = u'parmesan cheese',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Recipe14= Recipe(name=u'earl grey ham recipe',serves= 1,difficulty=u'easy',time=130,views=112,method=u"Preheat the oven to gas 5, 190°C, fan 170°C. Put the tea bags in a large measuring jug and cover with 350ml (12fl oz) boiled water. Set aside to brew. In a bowl, combine the sugar and mustard to make a thick paste.Using a sharp knife, pare the skin from the gammon joint, leaving a good layer of fat still attached to the meat. Score the fat in a criss-cross pattern and push cloves into the points where the scored lines cross. transfer to a small roasting tin, fat side up, and spoon over the mustard mixture in a thick, even layer.Squeeze the liquid out of the tea bags and discard. Pour the tea around the joint, then cover loosely with foil and cook for 2 hrs (or for 30 mins, plus 30 mins per 500g (1lb)), until cooked through. Remove the foil for the last 20 mins of cooking. Rest the ham for 10 mins, before carving.",user_id=3,image_file=u'temp14.jpg')
    Ingredients114 = Ingredients(amount=u'4',name = u'Earl Grey tea bags',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients115 = Ingredients(amount=u'50g',name = u'light brown soft sugar',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients116 = Ingredients(amount=u'50g',name = u'dijon mustard',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients117 = Ingredients(amount=u'1-1.5kg',name = u'unsmoked gammon joint',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients118 = Ingredients(amount=u'30',name = u'whole cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe15= Recipe(name=u'mushroom and feta risotto',serves= 2,difficulty=u'easy',time=50,views=178,method=u"Put the dried mushrooms in a heatproof jug, cover with 500ml boiling water and set aside. Meanwhile, heat 1 tbsp oil in a deep, wide frying pan and fry the chestnut mushrooms over a high heat for 4-5 mins until deep brown. Remove and set aside.Add the remaining ½ tbsp oil to the pan and fry the onions and garlic over a medium heat for 6-8 mins until soft and beginning to caramelise.Strain the dried mushrooms, reserving the liquid, then roughly chop and add to the pan. Add the rice and stir well. Stir in the wine and cook until the rice has absorbed it. Return the chestnut mushrooms to the pan then add the reserved mushroom liquid, a ladle at a time, stirring constantly. Wait until the rice has absorbed most of the liquid before adding more. Repeat until you've used all the liquid – this should take 20-25 mins.Once the rice is tender but with a little bite, season to taste. Stir through the spinach leaves until wilted. Divide between 2 plates and top with the feta.",user_id=29,image_file=u'temp15.jpg')
    Ingredients119 = Ingredients(amount=u'15g',name = u'dried porcini mushrooms',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients120 = Ingredients(amount=u'1 1/2tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients121 = Ingredients(amount=u'150g',name = u'chestnut mushrooms',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients122 = Ingredients(amount=u'1',name = u'small onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients123 = Ingredients(amount=u'1',name = u'garlic clove',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients124 = Ingredients(amount=u'140g',name = u'arborio rice',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients125 = Ingredients(amount=u'75ml',name = u'white wine',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients126 = Ingredients(amount=u'100g',name = u'baby spinach',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients127 = Ingredients(amount=u'50g',name = u'feta',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Recipe16= Recipe(name=u'parsnip and ginger soup with spiced roast chickpeas recipe',serves= 4,difficulty=u'easy',time=40,views=24,method=u"Preheat the oven to gas 7, 220°C, fan 200°C, and line a baking tray with nonstick baking paper. Heat 1 tbsp oil in a large saucepan over a medium heat and fry the onion for 5 mins to soften. Stir through the garlic, ginger and 1 tsp cumin and cook for 1 min.Add the parsnips, season and pour in the stock. Bring to the boil, then reduce the heat to medium-low and simmer for 25 mins until the parsnips are very tender.Meanwhile, toss the chickpeas with 1 tbsp oil, the ground coriander and remaining cumin. Arrange in a single layer on the lined tray and roast for 20-25 mins until golden and crisp.Use a food processor or hand blender to blend the soup until smooth. Reheat if necessary, then season to taste with black pepper and lemon juice and divide between 4 bowls. Toss the roasted chickpeas with the fresh coriander and scatter over the soup to serve.",user_id=2,image_file=u'temp16.jpg')
    Ingredients128 = Ingredients(amount=u'2tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients129 = Ingredients(amount=u'1',name = u'large onion',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients130 = Ingredients(amount=u'2',name = u'garlic cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients131 = Ingredients(amount=u'5cm piece',name = u'ginger',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients132 = Ingredients(amount=u'1 1/4tsp',name = u'ground cumin',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients133 = Ingredients(amount=u'500g',name = u'parsnips',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients134 = Ingredients(amount=u'1',name = u'vegetable stock cube',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients135 = Ingredients(amount=u'400g',name = u'chickpeas',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients136 = Ingredients(amount=u'3tsp',name = u'ground coriander',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients137 = Ingredients(amount=u'',name = u'lemon juice',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients138 = Ingredients(amount=u'10g',name = u'fresh coriander',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe17= Recipe(name=u'channa dhal recipe',serves= 4,difficulty=u'medium',time=40,views=137,method=u"Drain the lentils and put in a pan with 800ml fresh water. Bring to the boil and cook on a moderate heat for approximately 35 minutes or until they are well cooked and have gone mushy.In a separate pan heat the oil, add the cumin seeds, mustard seeds, curry leaves and asafoetida (if using) and cook for approximately 1 minute taking care not to burn the mixture.Add the Patak's Madras Paste and cook for a further 1 minute. Add the tomatoes and allow to cook for 2 minutes.Remove the pan from the heat and add all the mixture to the cooked lentils. Check the seasoning, and adjust the salt and add the sugar. Squeeze in the lemon juice and stir through the chopped fresh coriander. Serve with chapattis and rice.",user_id=38,image_file=u'temp17.jpg')
    Ingredients139 = Ingredients(amount=u'250g',name = u'dried yellow split peas / lentils',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients140 = Ingredients(amount=u'2tbsp',name = u'vegetable oil or ghee',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients141 = Ingredients(amount=u'1tsp',name = u'cumin seeds',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients142 = Ingredients(amount=u'1 handful',name = u'curry leaves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients143 = Ingredients(amount=u'1tsp',name = u'mustard seeds',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients144 = Ingredients(amount=u'',name = u'pinch asafoetida',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients145 = Ingredients(amount=u'',name = u'salt',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients146 = Ingredients(amount=u'1tsp',name = u'sugar',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients147 = Ingredients(amount=u'2tbsp',name = u'fresh coriander',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients148 = Ingredients(amount=u'4',name = u'lemon',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients149 = Ingredients(amount=u'1tbsp',name = u'madras paste',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients150 = Ingredients(amount=u'2',name = u'medium tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe18= Recipe(name=u'vegan butternut squash spaghetti with rocket and hazelnut pesto recipe',serves= 4,difficulty=u'medium',time=20,views=168,method=u"Put 25g hazelnuts, half the garlic and 50g rocket in a food processor and pulse a few times until roughly chopped. Add 125ml oil and the lemon juice then blend again until combined but not completely smooth – you want a pesto with a little bit of texture. Season to taste and set aside.Use a spiralizer to cut the squash quarters into thin ribbons (depending on the size of your spiralizer you may need to cut the squash into thinner wedges). If you don’t have a spiralizer, you can cut the squash into thin wedges then use a vegetable peeler to peel off ribbons.Heat the remaining oil in a large, wide pan, then add the squash ribbons and sauté for 2-3 mins – you may need to do this in batches. Add the remaining garlic and a splash of water to help the squash steam gently. Cook for 2 mins, trying not to stir too much as the squash may break up.Stir most of the rocket pesto into the pan (reserving some to serve) so that it just coats the squash and heats through.Divide the squash spaghetti between plates and top with the remaining rocket leaves, chopped hazelnuts and grated lemon zest. Drizzle over the remaining pesto and serve with a lemon wedge on the side to squeeze over.",user_id=35,image_file=u'temp18.jpg')
    Ingredients151 = Ingredients(amount=u'40g',name = u'toasted hazelnuts',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients152 = Ingredients(amount=u'2',name = u'garlic cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients153 = Ingredients(amount=u'70g',name = u'wild rocket',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients154 = Ingredients(amount=u'155ml',name = u'extra-virgin olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients155 = Ingredients(amount=u'4',name = u'lemon',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients156 = Ingredients(amount=u'1',name = u'butternut squash',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe19= Recipe(name=u'vegan roasted carrot risotto recipe',serves= 4,difficulty=u'medium',time=50,views=124,method=u"Preheat the oven to gas 7, 220°C, fan 200°C. Heat 3 tbsp of the oil in a wide saucepan or deep frying pan over a low heat. Add the onion, celery and the crushed garlic cloves. Pick the leaves from half the thyme sprigs and add to the pan along with a pinch of salt. Cover and cook gently for 10 mins or until softened, stirring occasionally.Meanwhile, place the carrots in a roasting tray with the whole garlic cloves and remaining thyme sprigs. Drizzle with the remaining 1 tbsp oil and season. Roast for 20-25 mins until just tender and slightly charred.Add the risotto rice to the onion mix and stir for 2 mins to toast the rice, then increase the heat to medium. Add the sherry (or wine) and simmer until the liquid has been absorbed. Add the hot stock one ladle at a time, stirring constantly and allowing the liquid to absorb each time before adding the next ladleful. Stop when you have about 2 ladles remaining.Remove the roasted carrots from the oven and discard the thyme sprigs. Set aside 12 of the carrots to serve, keeping warm. Add the rest of the carrots and garlic cloves (squeezed from their skins) to a food processor or blender with the remaining stock and blitz to a rough purée. Stir through the rice until fully combined, cooking for a final few minutes until the rice is tender.Add the seeds to a dry frying pan with a pinch of salt and toast for 2 mins over a medium heat, shaking the pan regularly to stop them burning. Serve the risotto garnished with the reserved carrots and toasted seeds sprinkled over.",user_id=46,image_file=u'temp19.jpg')
    Ingredients157 = Ingredients(amount=u'4tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients158 = Ingredients(amount=u'4',name = u'onions',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients159 = Ingredients(amount=u'2',name = u'celery sticks',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients160 = Ingredients(amount=u'4',name = u'garlic cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients161 = Ingredients(amount=u'7.5g',name = u'thyme',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients162 = Ingredients(amount=u'1pack',name = u'bunched carrots',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients163 = Ingredients(amount=u'300g',name = u'risotto rice',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients164 = Ingredients(amount=u'100ml',name = u'vegan dry sherry',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients165 = Ingredients(amount=u'1.25ltr',name = u'vegan vegetable stock',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients166 = Ingredients(amount=u'3tbsp',name = u'4 seed mix',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Recipe20= Recipe(name=u'baked herby carrots',serves= 4,difficulty=u'medium',time=50,views=89,method=u"Preheat the oven to gas 6, 200°C, fan 180°C and cut a 50cm length of nonstick baking paper. Fold it in half lengthways, then open up and put it on a baking sheet.Toss the carrots in a bowl with the bay leaf, garlic and seasoning. Lay the carrots along the crease of the paper and dot over the butter. Make a parcel by bringing the paper up over the carrots, folding the top to seal, then fold up the short ends. Bake for 40 minutes. Serve opened and sprinkled with herbs.",user_id=43,image_file=u'temp20.jpg')
    Ingredients167 = Ingredients(amount=u'450g',name = u'tendersweet carrots',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients168 = Ingredients(amount=u'1',name = u'dried bay leaf',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients169 = Ingredients(amount=u'5',name = u'garlic cloves',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients170 = Ingredients(amount=u'2tbsp',name = u'butter',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients171 = Ingredients(amount=u'',name = u'fresh herbs',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe21= Recipe(name=u'roasted maple and cumin roots',serves= 3,difficulty=u'hard',time=60,views=84,method=u"Preheat the oven to gas 6, 200°C, fan 180°C. Slice the carrots and parsnips lengthways in half (or quarter, if large). Chop the beetroot and celeriac into evenly sized chunks or wedges. Arrange in a roasting tin.Drizzle the veg with the oil and scatter over the cumin and thyme. Season well and toss to coat. Nestle the garlic halves in the tin, cut-sides up. Roast for 35 minutes, turning occasionally, until the veg is softened.Meanwhile, in a jug, mix the maple syrup with the mustard. Remove the roots from the oven and drizzle over the maple mixture. Toss to coat, then return to the oven for 10-15 minutes more, until golden.",user_id=39,image_file=u'temp21.jpg')
    Ingredients172 = Ingredients(amount=u'300g',name = u'carrots',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients173 = Ingredients(amount=u'300g',name = u'parsnips',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients174 = Ingredients(amount=u'300g',name = u'beetroot',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients175 = Ingredients(amount=u'300g',name = u'celeriac',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients176 = Ingredients(amount=u'2tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients177 = Ingredients(amount=u'1 1/2tsp',name = u'cumin seeds',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients178 = Ingredients(amount=u'1handful',name = u'thyme prigs',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients179 = Ingredients(amount=u'1',name = u'garlic bulb',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients180 = Ingredients(amount=u'3tbsp',name = u'maple syrup',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients181 = Ingredients(amount=u'1tbsp',name = u'dijon mustard',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe22= Recipe(name=u'florentine pizza',serves= 4,difficulty=u'hard',time=30,views=103,method=u"To make the pizza dough, mix the flour, sugar, 2 tsp salt, and yeast in a bowl. Stir in the oil and add about 300ml lukewarm water to make a soft, but not sticky dough.Tip onto a floured work surface and knead for 10 mins. Transfer to a clean bowl, cover with oiled clingfilm and set aside to prove in a warm place for 1 hr, or until doubled in size.Meanwhile, cook the tomatoes in a pan until thickened and reduced; season well. Preheat the oven to its highest setting. Divide the dough into 4 and shape each into a ball. Roll out thinly and put on 4 baking sheets lined with nonstick baking paper.Spread each base with tomato sauce, then scatter over the spinach, mozzarella and ham. Bake, in batches if needed, for 8 mins.Crack an egg in the centre of each pizza. Continue baking for 2-3 mins more, until the egg is just set and the crust is crisp.",user_id=47,image_file=u'temp22.jpg')
    Ingredients182 = Ingredients(amount=u'400g',name = u'chopped tomatoes',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients183 = Ingredients(amount=u'240g',name = u'baby spinach',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients184 = Ingredients(amount=u'125g',name = u'mozzarella ball',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients185 = Ingredients(amount=u'250g',name = u'grated mozzarella',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients186 = Ingredients(amount=u'88g',name = u'parma ham',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients187 = Ingredients(amount=u'4',name = u'eggs',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients188 = Ingredients(amount=u'500g',name = u'strong bread flour',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients189 = Ingredients(amount=u'1tsp',name = u'caster sugar',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients190 = Ingredients(amount=u'14g',name = u'dreid yeast',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients191 = Ingredients(amount=u'2tbsp',name = u'extra-virgin olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe23= Recipe(name=u'star pizzas',serves= 4,difficulty=u'medium',time=30,views=181,method=u"Preheat the grill to medium high. Flatten the bread slightly by rolling with a rolling pin, then cut out different shapes (stars, hearts or whatever you have to hand) using biscuit cutters. Place on a baking sheet, brush with the oil and grill for 3-4 minutes or until just turning golden.Turn the bread shapes over and spread with the basil and tomato sauce. Add the ham or pepperoni and top with the mozzarella pearls. Grill for a further 5-6 minutes or until the cheese has melted and is turning golden.",user_id=19,image_file=u'temp23.jpg')
    Ingredients192 = Ingredients(amount=u'4 slices',name = u'white medium bread',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients193 = Ingredients(amount=u'2tbsp',name = u'olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients194 = Ingredients(amount=u'50g',name = u'fresh basil and tomato sauce',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients195 = Ingredients(amount=u'2 slices',name = u'parma ham',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients196 = Ingredients(amount=u'100g',name = u'mozzarella pearls',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Recipe24= Recipe(name=u'free-from apple crumble',serves= 2,difficulty=u'hard',time=60,views=110,method=u"Preheat the oven to gas 5, 190°C, fan 170°C. Put the apples in a 25 x 16cm ovenproof dish at least 5cm deep.Pour over the lemon juice and toss to coat. Scatter over the sultanas and cinnamon, then drizzle with 60g maple syrup. Mix well, then put the dish on a baking tray and bake for 10 mins.Meanwhile, mix the flour and oats in a large bowl. Rub in the spread with your fingertips, then stir in the nuts, cranberries and 100g maple syrup until just combined. Don't overmix as it can become sticky.Scatter the topping over the baked apple mixture but don’t pack it down. Bake for a further 35 mins or until lightly golden-brown on top and bubbling at the edges. Leave to cool slightly, then serve with dairy-free cream or ice cream, if you like.",user_id=16,image_file=u'temp24.jpg')
    Ingredients197 = Ingredients(amount=u'3',name = u'Bramley apples',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients198 = Ingredients(amount=u'4',name = u'lemon',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients199 = Ingredients(amount=u'60g',name = u'sultanas',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients200 = Ingredients(amount=u'2tsp',name = u'ground cinnamon',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients201 = Ingredients(amount=u'60g',name = u'maple syrup',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients202 = Ingredients(amount=u'175g',name = u'gluten-free plain flour',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients203 = Ingredients(amount=u'90g',name = u'gluten-free plain oats',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients204 = Ingredients(amount=u'90g',name = u'coconut oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients205 = Ingredients(amount=u'50g',name = u'pecans',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients206 = Ingredients(amount=u'50g',name = u'hazelnuts',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients207 = Ingredients(amount=u'50g',name = u'dried cranberries',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients208 = Ingredients(amount=u'100g',name = u'maple syrup',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients209 = Ingredients(amount=u'',name = u'dairy free ice cream',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Recipe25= Recipe(name=u'ricotta, pea and mint ravioli',serves= 4,difficulty=u'hard',time=70,views=123,method=u"Briefly blitz the flour and salt in a food processor. Add the eggs and blitz for 1 min or until it resembles breadcrumbs. Tip out onto a lightly floured surface. Knead for 5-10 mins until you have a smooth, soft dough. Shape into a ball, wrap in clingfilm and chill in the fridge for at least 30 mins.Meanwhile, boil half the peas for 3 mins. Drain, run under cold water to cool, then drain well. Put in a bowl with 1 tbsp oil and crush with a fork. Stir in the ricotta, chives and chopped mint; season. Cover with clingfilm and chill.Divide the pasta dough into 4 pieces, wrap 3 in clingfilm and return them to the fridge. On a lightly floured surface, roll out the other piece to 15 x 50cm.Place 5 heaped teaspoons of filling along a long side of the pasta, with a 2cm border along the edge and about 4cm between each scoop. Fold the pasta in half lengthways over the filling and press down around it. Cut into 5 ravioli and use a fork to seal the edges. Dust with flour and set aside. Repeat with the remaining pasta and filling.Bring a very large pan of salted water to the boil. Add the ravioli one by one, then the remaining peas. Cook for 4 mins until al dente. Gently drain and return to the pan. Add the remaining oil and the zest; gently toss to coat. Season with black pepper, scatter over the reserved mint leaves and serve with the lemon slices and grated cheese.",user_id=29,image_file=u'temp25.jpg')
    Ingredients210 = Ingredients(amount=u'300g',name = u'plain flour',is_vegetarian=1,is_vegan=1,is_gluten_free=0)
    Ingredients211 = Ingredients(amount=u'4tsp',name = u'salt',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients212 = Ingredients(amount=u'3',name = u'eggs',is_vegetarian=0,is_vegan=0,is_gluten_free=1)
    Ingredients213 = Ingredients(amount=u'600g',name = u'frozen peas',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients214 = Ingredients(amount=u'250g',name = u'ricotta',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
    Ingredients215 = Ingredients(amount=u'4tbsp',name = u'extra-virgin olive oil',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients216 = Ingredients(amount=u'15g',name = u'chives',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients217 = Ingredients(amount=u'30g',name = u'mint',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients218 = Ingredients(amount=u'1',name = u'lemon',is_vegetarian=1,is_vegan=1,is_gluten_free=1)
    Ingredients219 = Ingredients(amount=u'',name = u'vegetarian hard cheese',is_vegetarian=1,is_vegan=0,is_gluten_free=1)
